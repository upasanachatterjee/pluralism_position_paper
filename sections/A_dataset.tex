...
\subsection{Dataset}
We use the ConflictingQA dataset \citep{wan-etal-2024-evidence} for our experiments. The original dataset contains 419 questions, from which we manually select 90: 45 epistemic and 45 aleatoric. Tables~\ref{tab:epistemic_questions} and~\ref{tab:aleatoric_questions} list these questions with their categories.
